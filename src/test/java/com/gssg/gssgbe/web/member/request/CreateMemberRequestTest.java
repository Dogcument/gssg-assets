...
class CreateMemberRequestTest {
    ...
    public void success(Member member) {
        // given
        CreateMemberRequest reqeust = new CreateMemberRequest(member.getEmail(), member.getPassword());
    ...
    public void fail(Member member) {
        // given
        CreateMemberRequest request = new CreateMemberRequest(member.getEmail(), member.getPassword());
